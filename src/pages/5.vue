  ...
  export default { 
    data(){
      return{
        ...
        name:"那些年，我们一起追过的女孩",
        year:"2012",
        img:"../../static/img/dy/p1062824805.jpg",
        bq:[{nr:"青春",cc:false,aa:2},{nr:"浪漫",cc:false,aa:2},{nr:"爱情",cc:false,aa:2},{nr:"校园",cc:false,aa:2},{nr:"文艺",cc:false,aa:2},{nr:"剧情",cc:false,aa:2},{nr:"治愈",cc:false,aa:2},{nr:"温情",cc:false,aa:2}],
